@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between px-4 py-3 dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800 border-t">
                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                ...
                                @elseif ($page == 2 || $page == $paginator->lastPage() - 1)
                                    <span aria-disabled="true">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 dark:bg-gray-800 dark:border-gray-600">...</span>
                                    </span>
                                @endif
                            @endforeach
                        @endif
